...
ActiveRecord::Schema.define(version: 20160205125724) do
  ...
  add_index "destination_images", ["destination_id"], name: "index_destination_images_on_destination_id", using: :btree
